    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-12">
        ...
        <form className="w-full flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
          <div className="flex flex-col sm:flex-row gap-4">
            <label className="flex flex-col gap-2 flex-1">
              ...
              <input
                ...
                className="glass-input rounded-xl px-4 h-12 w-full"
              />
            </label>
            <label className="flex flex-col gap-2 flex-1">
          ...
          <button type="submit" className="send-btn mt-2">
            Send Message
          </button>
        </form>
        ...
        {/* Footer */}
        <footer className="w-full text-center border-t border-white/5 pt-8">
